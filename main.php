        ...
        <div class="pagination-container">
            ...
            <form class="form-inline justify-content-end" method="POST" action="search.php">
                <div class="input-group">
                    <input type="text" name="aadhaar" class="form-control" pattern="\d*" minlength="12" maxlength="12" placeholder="Enter Aadhaar Number to Search" required/>
                    <div class="input-group-append">
                        <button type="submit" class="btn btn-outline-success" name="search" id="">Search Record</button>
                    </div>
                </div>
            </form>
        </div>
